...
assert.doesNotMatch(screen, /PaymentLoadingOverlay|waitForPaymentLoader/);
assert.doesNotMatch(commerce, /PaymentLoadingOverlay|waitForPaymentLoader/);
assert.match(screen, /Cargando opciones de pago/);
assert.match(commerce, /Cargando opciones de pago/);
