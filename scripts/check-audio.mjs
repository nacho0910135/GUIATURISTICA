...
assert.match(messages, /const file = new File\(attachment\.uri\)/);
assert.match(messages, /bytes = await file\.arrayBuffer\(\)/);
assert.doesNotMatch(messages, /fetch\(attachment\.uri\)/);
