...
- **Destinos cercanos en Explorar:** la lista es temporal y nace cerrada. Se cierra antes de abrir una ficha o cualquier otro flujo, al cambiar de pestaña y siempre que Explorar pierde el foco; volver a Explorar nunca restaura esa lista desplegada.
...
- **Actividad en comentarios:** cada comentario usa la misma familia de seis reacciones disponible en publicaciones. Una reacción o respuesta notifica al propietario del comentario en Notificaciones de Perfil. Las respuestas también muestran una sola vez un banner global de 5 segundos; tocar la fila o el banner abre el comentario original resaltado en el Foro.
- **Despliegue de comentarios:** publicaciones y rodadas muestran el total de comentarios en una barra cerrada por defecto. El hilo y su compositor sólo se despliegan mediante una acción explícita sobre esa barra; una navegación desde notificaciones puede abrir directamente el hilo de la publicación para revelar el comentario señalado.
...
- Las tarjetas, listas, detalles, filtros de sitios y comercios, y el planificador usan la distancia y duración por carretera devueltas por Mapbox Directions. Cada resultado válido se guarda localmente; si Mapbox no está disponible se muestra el último trayecto guardado con la etiqueta «Última consulta», y sólo sin caché se indica que la distancia no está disponible. Nunca se sustituye silenciosamente por una distancia geodésica.
