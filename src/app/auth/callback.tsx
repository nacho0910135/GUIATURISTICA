...
export default function OAuthCallback() {
  ...
  // AppProvider completes the deep-link exchange. Do not leave this route
  // until Supabase confirms the session, otherwise Android can reveal the
  // launcher while the Chrome custom tab is being dismissed.
  useEffect(() => {
