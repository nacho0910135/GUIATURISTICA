...
function notificationText(type: string, language: 'es' | 'en') { const labels = { like: ['reaccionó a tu publicación', 'reacted to your post'], follow: ['empezó a seguirte', 'started following you'], comment: ['respondió a tu conversación', 'replied to your conversation'], new_post: ['publicó algo nuevo', 'published something new'], message: ['te envió un mensaje', 'sent you a message'] } as Record<string, [string, string]>; const value = labels[type] ?? ['generó una actividad nueva', 'created new activity']; return tr(language, ...value); }
