...
const distanceLabel = roadDistanceLabel;
...
export default function CommerceScreen() {
  ...
  const roadCandidates = [...(directory.data?.featured ?? []), ...(directory.data?.organic ?? [])];
  const roadDistance = useRoadDistances(userLocation, detail ? [...roadCandidates, detail] : roadCandidates);
  const catalog = roadCandidates.map((service) => ({ ...service, distance_km: roadDistance(service) ?? null }))
