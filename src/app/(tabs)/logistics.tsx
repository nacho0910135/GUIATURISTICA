...
type Language = 'es' | 'en';
const categories = ['Todo', 'Playa', 'Catarata', 'Parque'];
...
function categoryLabel(value: string, language: Language) { return value === 'Todo' ? copy(language, 'Todo', 'All') : value === 'Playa' ? copy(language, 'Playa', 'Beach') : value === 'Catarata' ? copy(language, 'Catarata', 'Waterfall') : copy(language, 'Parque', 'Park'); }
