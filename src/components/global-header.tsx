      ...
      <Animated.View className="mx-auto w-full max-w-content px-4 py-2.5 md:flex-row md:items-center md:justify-between md:px-6" style={{ opacity: entrance, transform: [{ translateY: entrance.interpolate({ inputRange: [0, 1], outputRange: [-10, 0] }) }] }}>
        ...
        <View className="mt-2 flex-row flex-wrap items-center justify-between gap-2 md:mt-0 md:justify-end">
          ...
          <IconButton
            ...
            icon={<View className="relative h-full w-full items-center justify-center overflow-hidden rounded-full"><Image contentFit="contain" source={require('@/assets/iconos propios/brujula.png')} style={{ height: 52, transform: [{ translateY: -5 }], width: 52 }} /><AnimatedShine travel={76} /></View>}
