...
La brújula abre cartografía urbana real a pantalla completa, con retorno superior izquierdo. La rosa translúcida tiene facetas y relieve; sus cardinales permanecen alineados con el mapa norte-arriba. La aguja azul indica el rumbo geográfico calibrado del teléfono, suavizado sin saltos al cruzar 0°. Tocar la rosa vuelve a centrar la ubicación precisa. Sin sensor o calibración válida no se dibuja una orientación supuesta.
...
En el directorio, `colors.commerceAction` identifica exclusivamente la acción “Registrar comercio” con verde bosque (`#568B68` a `#3F7652`), borde claro y base sombreada. Este acceso y “Panel de propietarios” comparten un relieve corto y un brillo diagonal pausado; el panel conserva su acento dorado. Con movimiento reducido, el brillo se elimina y la jerarquía permanece por color, borde y profundidad.

### Planes Pro

La pasarela usa tarjetas de dosel a pantalla útil completa: perezoso para el plan mensual, mono cariblanco para el anual y jaguar para el comercial. La fauna es ilustración naturalista recortada, se integra al borde de cada tarjeta y sólo tiene un movimiento ambiental lento; Reduced Motion la deja estática. Los fondos muestran selva tropical fotográfica a sangre completa y concentran título, detalle y precio en un panel translúcido para conservar contraste. El mensual usa borde plata; anual y comercial usan el dorado de `commerceGold`. El plan anual conserva el mayor énfasis y toda la tarjeta activa la compra, sin alterar el contrato financiero ni la acción primaria.
